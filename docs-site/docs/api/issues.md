---
title: Issues
description: Issue CRUD, checkout/release, comments, and attachments
---

Issues are the unit of work in Baton. They support hierarchical relationships, atomic checkout, comments, and file attachments.
