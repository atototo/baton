---
title: Database
description: Embedded PGlite vs Docker Postgres vs hosted
---

Baton uses PostgreSQL via Drizzle ORM. There are three ways to run the database.
...
1. Creates `~/.baton/instances/default/db/` for storage
2. Ensures the `baton` database exists
3. Runs migrations automatically
4. Starts serving requests

Data persists across restarts. To reset: `rm -rf ~/.baton/instances/default/db`.
