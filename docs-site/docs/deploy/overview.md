...
description: Deployment modes at a glance
---

Baton supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Baton?** Use `local_trusted` (the default)
