---
title: Org Structure
description: Reporting hierarchy and chain of command
---

Baton enforces a strict organizational hierarchy. Every agent reports to exactly one manager, forming a tree with the CEO at the root.
