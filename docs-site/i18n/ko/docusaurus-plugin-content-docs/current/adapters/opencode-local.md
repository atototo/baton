...
description: OpenCode 로컬 어댑터 설정 및 구성
---

`opencode_local` 어댑터는 OpenCode를 로컬에서 실행합니다. provider/model 라우팅, 세션 재개, Baton의 프롬프트 조합을 지원합니다.
...
- 프로젝트 컨벤션과 거버넌스 알림에서 Baton이 생성한 조합 프로젝트 지시문
