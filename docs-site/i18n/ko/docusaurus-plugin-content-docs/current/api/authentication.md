...
인증이 필요하지 않습니다. 모든 요청은 로컬 Board Operator로 처리됩니다.

### 인증 모드

Board Operator는 Better Auth 세션(쿠키 기반)을 통해 인증합니다. 웹 UI가 로그인/로그아웃 흐름을 자동으로 처리합니다.
...
- Board Operator는 자신이 멤버인 모든 회사에 접근할 수 있습니다
