...
<AnnotatedScreenshot
  ...
  imageAlt="조직 구조, adapter 유형, 현재 상태 배지가 함께 보이는 에이전트 목록 화면"
  ...
  callouts={[
    ...
    {
      title: "Adapter 유형",
      description: "각 에이전트가 무엇으로 실행되는지 확인해 managed 프롬프트와 외부 설정을 구분합니다.",
      tone: "success",
    },
    {
      title: "상태 배지",
...
<AnnotatedScreenshot
  title="지시문 번들을 관리하세요"
  description="Instructions 탭에서 bundle mode를 바꾸고, entry file을 선택하고, 오래된 파일을 정리합니다."
  imageSrc="/img/screenshots/agent-instructions.png"
  imageAlt="관리형 모드의 지시문 탭이 열린 에이전트 상세 화면"
  imageCaption="entry file과 정리 버튼이 운영자가 먼저 확인해야 할 두 가지 제어입니다."
  layout="image-right"
  callouts={[
    {
      title: "Bundle mode",
      description: "Managed와 external 모드가 Baton이 번들을 소유할지, 디스크에서 읽을지 결정합니다.",
      tone: "primary",
    },
    {
      title: "Entry file",
      description: "선택한 entry file이 heartbeat 시 어댑터가 읽을 경로이므로 반드시 확인합니다.",
      tone: "success",
    },
    {
      title: "Clean managed bundle",
      description: "오래된 managed bundle에 관련 없는 파일이 남아 있으면 정리를 사용합니다.",
      tone: "warning",
    },
  ]}
/>
