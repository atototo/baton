...
- installed adapter list for this Baton instance
...
## 8. New Skill: `baton-create-agent`

Create new skill directory:

- `skills/baton-create-agent/SKILL.md`
...
Also update `skills/baton/SKILL.md` to reference this skill for hiring workflows.
...
- `baton-create-agent` skill + docs updates
