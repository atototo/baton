...
- You want Baton heartbeat/task events delivered over HTTP.

Don't use when:
- You need local CLI execution inside Baton (use claude_local/codex_local/opencode_local/process).
- The OpenClaw endpoint is not reachable from the Baton server.
