...
function resolveBatonHomeDir(): string {
...
function resolveBatonInstanceId(): string {
  const raw = process.env.BATON_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveBatonHomeDir(), "instances", resolveBatonInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveBatonHomeDir(), "instances", resolveBatonInstanceId(), "data", "backups");
}
