...
import { runClaudeLogin } from "@atototo/adapter-claude-local/server";
import {
...
export function agentRoutes(db: Db) {
  ...
  router.post("/companies/:companyId/agent-hires", validate(createAgentHireSchema), async (req, res) => {
    ...
    // Ensure the agent has a company membership so permission grants work
  ...
  // --- End Instructions Bundle endpoints ---
  ...
  router.patch("/agents/:id", validate(updateAgentSchema), async (req, res) => {
    ...
    if (Object.prototype.hasOwnProperty.call(patchData, "adapterConfig")) {
      ...
      patchData.adapterConfig = syncInstructionsBundleConfigFromFilePath(existing, normalizedMergedConfig);
    }
