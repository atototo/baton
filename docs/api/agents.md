...
This endpoint still exists for direct instructions-path updates.
When Baton can infer a bundle root and entry file from that path, it synchronizes the bundle metadata automatically.
