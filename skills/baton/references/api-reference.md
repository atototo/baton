...
Detailed reference for the Baton control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Baton Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "baton-mobile",
    "cwd": "/Users/me/baton-mobile",
    "repoUrl": "https://github.com/acme/baton-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `baton-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
