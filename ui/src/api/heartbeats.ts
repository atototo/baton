import type { HeartbeatRun, HeartbeatRunEvent } from "@atototo/shared";
...
export const heartbeatsApi = {
  ...
  listInboxFailedRuns: (companyId: string, limit = 50) =>
    api.get<HeartbeatRun[]>(
      `/companies/${companyId}/inbox-failed-runs?limit=${encodeURIComponent(String(limit))}`,
    ),
