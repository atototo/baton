import type { Approval, ApprovalComment, Issue } from "@atototo/shared";
...
export const approvalsApi = {
  ...
  approve: (id: string, decisionNote?: string, force?: boolean) =>
    api.post<Approval>(`/approvals/${id}/approve`, { decisionNote, force }),
