...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@atototo/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@atototo/adapter-utils").TranscriptEntry[];
