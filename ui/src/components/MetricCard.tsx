...
export function MetricCard({ icon: Icon, value, label, description, to, onClick }: MetricCardProps) {
  ...
  const inner = (
    <div className={`h-full bg-card border border-border rounded-lg px-4 py-4 sm:px-5 sm:py-5 transition-colors${isClickable ? " hover:bg-accent/40 cursor-pointer" : ""}`}>
