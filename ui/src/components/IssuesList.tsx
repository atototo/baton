          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="ghost" size="sm" className={`text-xs ${activeFilterCount > 0 ? "text-blue-600 dark:text-blue-400" : ""}`}>
                ...
                <span className="hidden sm:inline">{activeFilterCount > 0 ? t("issuesList.filtersWithCount", { count: activeFilterCount }) : t("issuesList.filter")}</span>
                {activeFilterCount > 0 && (
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {quickFilterPresets.map((preset) => {
                      ...
                      return (
                        ...
                        >
                          {t(`issuesList.${preset.label.toLowerCase()}`)}
                        </button>
                      );
                    })}
                  </div>
                ...
                <div className="p-2 space-y-0.5">
                  {([
                    ...
                    <button
                      ...
                      onClick={() => updateView({ groupBy: value as IssueViewState["groupBy"] })}
                    >
                      <span>{label}</span>
